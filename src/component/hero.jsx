            ...
            <div id='video-frame' className='relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75'>
                <div>
                    <div className='mask-clip-path absolute-center z-50 size-64 cursor-pointer rounded-lg '>
                        <div onClick={handelMiniVideoClick} className='origin-center sclae-50 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100'>
                            <video
                                ref={nextVdRef}
                ...
                <div className='absolute left-0 top-0 z-40 size-full'>
                    <div className='mt-24 px-5 sm:px-10'>
                        ...
                        <p className='mb-5 max-w-64 font-robert-regula text-blue-50'>
                            Enter the Metagame Layer <br />
                            Uleash trhe Play Economy
                        </p>
                        <Button id='watch-trailer' title='watch-trailer' leftIcons={<TiLocationArrow />} containerClass='bg-yellow-300 flex-center gap-1' />
                    </div>
                </div>
            </div>
